#!/usr/bin/env python3
"""Minimal Cloud Run HTTP stub for worker trigger (PR-24)."""
...
class _Handler(BaseHTTPRequestHandler):
    server_version = "caf-worker-stub/1.0"
    ...
    def do_POST(self) -> None:  # noqa: N802
        ...
        _json_response(
            ...
            HTTPStatus.ACCEPTED,
            {
                ...
                "action": "trigger",
                "job_id": job_id,
                "message": "Accepted by stub. No render executed.",
            },
        )
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Cloud Run worker HTTP stub.")
    parser.add_argument(
        "--port",
        type=int,
    ...
    print(f"worker stub listening on :{args.port}")
