...
def main(argv: list[str]) -> int:
    ...
    if rc != 0:
        print("ERROR: planner_cli failed for sora_lab smoke", file=sys.stderr)
        return 1
    ...
    if vrc != 0:
        print("ERROR: generated sora_lab job failed validate_job", file=sys.stderr)
        return 1
    print("OK: planner sora_lab provider smoke")
