...
def test_budget_enforcement():
    ...
    try:
        ...
        assert (
            "Budget exceeded" in result.stdout
        ), "Expected stdout to mention budget exhaustion"
        ...
        assert (
            last_event["event"] == "BUDGET_EXCEEDED"
        ), f"Expected BUDGET_EXCEEDED event, got {last_event['event']}"
