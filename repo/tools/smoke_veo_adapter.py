...
def main():
    ...
    try:
        ...
        print("PIL not installed, skipping image creation. Adapter will rely on fallback behavior if mocked correctly.")
        pass
    ...
    cmd = [
        ...
        "--project", "gen-lang-client-0381423928"
    ]
    ...
    if output_video.exists() and output_video.stat().st_size > 0:
        print(f"Success! Output video created at {output_video} ({output_video.stat().st_size} bytes)")
    else:
