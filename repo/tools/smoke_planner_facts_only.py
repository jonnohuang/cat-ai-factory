...
def main() -> int:
    ...
    job = {
        ...
        "shots": [
            {"t": 0, "visual": "locked camera cat dance", "action": "pose hit", "caption": "start"},
            {"t": 5, "visual": "static frame dance", "action": "paw pop", "caption": "middle"},
            {"t": 10, "visual": "locked final pose", "action": "reset", "caption": "end"},
            {"t": 11, "visual": "locked final pose", "action": "reset", "caption": "end"},
            {"t": 12, "visual": "locked final pose", "action": "reset", "caption": "end"},
            {"t": 13, "visual": "locked final pose", "action": "reset", "caption": "end"}
        ],
        "captions": ["a", "b", "c", "d"],
        "hashtags": ["#cat", "#loop", "#dance"],
        "render": {"background_asset": "sandbox/assets/demo/mochi_dance_loop_swap.mp4", "subtitle_style": "big_bottom", "output_basename": "facts-smoke"}
    }
