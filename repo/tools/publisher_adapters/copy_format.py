...
def resolve_caption(platform_plan: Dict[str, Any], clip: Dict[str, Any], lang: str) -> str:
...
def format_copy(platform: str, platform_plan: Dict[str, Any], clip: Dict[str, Any], lang: str) -> str:
