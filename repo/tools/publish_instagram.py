...
def main():
    parser = argparse.ArgumentParser(description="Instagram Publisher (ADR-0021 Bundle Generator)")
    ...
    try:
        ...
        if bundle_path:
            ...
            print("No plan found for Instagram. Use --publish-plan with correct content.")
            sys.exit(0)
